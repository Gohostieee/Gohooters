...
const Resume = () => {
	...
	return(
			...
			<h2 class="hero cyberpunk layers mt-2" data-text="EGO DEATH"><span>RESUME</span></h2>
				...
				<p class = " sm:hidden text-white text-lg QuickSand mt-4 font-thin mr-4 ml-4">If you are on mobile then you can't see this pdf, so you can download it <a class="underline underline-offset-4" href={resume} target="_blank">here</a></p>
