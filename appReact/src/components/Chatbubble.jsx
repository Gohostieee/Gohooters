...
export default class Chatbubble extends Component {
	...
	componentDidMount(){
		this.setState({Modal:<Modal approved={function (){window.location.href="/mainmenu"}} text = "YOU ARE NOW ABOUT TO LEAVE, ARE YOU SURE YOU WANT TO CONTINUE?" button={[$("#skip")]}/>})
